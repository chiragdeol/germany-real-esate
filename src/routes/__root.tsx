...
import faviconUrl from "@/assets/logo-full.png";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Civita Capital — Connecting Cities with Investors" },
      {
        name: "description",
        content:
          "A European investment introduction firm helping municipalities attract strategic capital and giving investors access to curated, off-market opportunities.",
      },
      { name: "author", content: "Civita Capital" },
      { property: "og:title", content: "Civita Capital — Connecting Cities with Investors" },
      {
        property: "og:description",
        content:
          "Curated investment opportunities across European municipalities. Personally introduced, never auto-matched.",
      },
